import { callFunction, callTestnetFunction } from "@/clients/alchemy"
...
export async function getIsSubscribed(address: string) {
    ...
    const response = await callTestnetFunction(process.env.NEXT_PUBLIC_SUBSCRIPTION_ADDRESS!, encoded)
