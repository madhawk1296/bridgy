export default function Potion({ selected=true }: { selected?: boolean}) {
    return (
        <svg viewBox="0 0 290.2 290.2" xmlns="http://www.w3.org/2000/svg" className={`h-full ${selected ? "fill-red-500" : "fill-gray-600" }`} >
            <g transform="matrix(1, 0, 0, 1, 319.775105, 104.887525)"/>
            <g transform="matrix(1, 0, 0, 1, 319.775105, 104.887525)"/>
            <g transform="matrix(1, 0, 0, 1, 319.775105, 104.887525)"/>
            <g transform="matrix(1, 0, 0, 1, 319.775105, 104.887525)"/>
            <g transform="matrix(1, 0, 0, 1, 319.775105, 104.887525)"/>
            ...
            <g transform="matrix(1, 0, 0, 1, 319.775105, 104.887525)"/>
            <g transform="matrix(1, 0, 0, 1, 319.775105, 104.887525)"/>
            <g transform="matrix(0.566797, 0, 0, 0.566797, -0.000056, 0.00011)">
                <g>
            ...
            <g transform="matrix(0.234375, 0, 0, 0.234375, -75.132454, 9.605714)"/>
            <g transform="matrix(0.234375, 0, 0, 0.234375, -75.132454, 9.605714)"/>
            <g transform="matrix(0.234375, 0, 0, 0.234375, -75.132454, 9.605714)"/>
            <g transform="matrix(0.234375, 0, 0, 0.234375, -75.132454, 9.605714)"/>
            <g transform="matrix(0.234375, 0, 0, 0.234375, -75.132454, 9.605714)"/>
